...
export const providersListEntity = defineAdminEntity<Provider>({
  ...
  fields: [
    ...
    { name: 'providerType', label: 'ProviderType', type: 'text', table: true, form: { required: true } },
    { name: 'priority', label: 'Priority', type: 'number', table: true, form: { col: 6 } },
    { name: 'balance', label: 'Balance', type: 'text', table: true, form: { col: 6 } },
    {
      name: 'status',
      label: 'Status',
      type: 'select',
...
export const providerProductsEntity = defineAdminEntity<ProviderProduct>({
  ...
  fields: [
    ...
    { name: 'providerProductCode', label: 'ProviderProductCode', type: 'text', table: { variant: 'code' }, form: { required: true } },
    { name: 'providerProductName', label: 'ProviderProductName', type: 'text', table: { variant: 'primary' }, form: { required: true } },
    { name: 'costPrice', label: 'CostPrice', type: 'number', table: true, form: { col: 6 } },
    { name: 'currencyCode', label: 'CurrencyCode', type: 'text', table: true, form: { col: 6 } },
    { name: 'stockStatus', label: 'StockStatus', type: 'text', table: true, form: { required: true } },
...
export const providerMappingEntity = defineAdminEntity<ProductMapping>({
  ...
  fields: [
    { name: 'localProductType', label: 'LocalProductType', type: 'text', table: true, form: { required: true, col: 6 } },
    { name: 'localProductId', label: 'LocalProductId', type: 'number', table: true, form: { required: true, col: 6 } },
    {
      name: 'providerId',
      label: 'ProviderId',
      type: 'select',
    ...
    { name: 'providerProductId', label: 'ProviderProductId', type: 'number', table: true, form: { required: true, col: 6 } },
    { name: 'priority', label: 'Priority', type: 'number', table: true, form: { col: 6 } },
    { name: 'isBackup', label: 'IsBackup', type: 'checkbox', table: true, form: { col: 6 } },
...
export const providerApiConfigsEntity = defineAdminEntity<ProviderApiConfig>({
  ...
  fields: [
    ...
    { name: 'baseUrl', label: 'BaseUrl', type: 'url', table: true, form: { required: true } },
    { name: 'apiKey', label: 'ApiKey', type: 'password', form: { required: true } },
    { name: 'secretKey', label: 'SecretKey', type: 'password', form: { required: true } },
    { name: 'timeoutSeconds', label: 'TimeoutSeconds', type: 'number', table: true, form: { col: 6 } },
    { name: 'sandboxMode', label: 'SandboxMode', type: 'checkbox', table: true, form: { col: 6 } },
...
export const providerStocksEntity = defineAdminEntity<ProviderStockRow>({
  ...
  fields: [
    ...
    { name: 'providerProductCode', label: 'ProviderProductCode', type: 'text', table: { variant: 'code' }, form: { required: true } },
    { name: 'available', label: 'Available', type: 'checkbox', table: true },
    { name: 'costPrice', label: 'CostPrice', type: 'number', table: true },
    { name: 'checkedAt', label: 'CheckedAt', type: 'text', table: true, form: false },
...
export const providerLogsEntity = defineAdminEntity<ProviderLog>({
  ...
  fields: [
    ...
    { name: 'providerId', label: 'ProviderId', type: 'number', table: true, form: false },
    { name: 'orderId', label: 'OrderId', type: 'text', table: { variant: 'code' }, form: false },
    { name: 'endpoint', label: 'Endpoint', type: 'text', table: true, form: false },
    { name: 'requestBody', label: 'RequestBody', type: 'textarea', form: false, table: false },
    { name: 'responseBody', label: 'ResponseBody', type: 'textarea', form: false, table: false },
    { name: 'statusCode', label: 'StatusCode', type: 'number', table: true, form: false },
