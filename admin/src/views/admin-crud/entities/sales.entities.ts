...
import { isActiveField, sortOrderField } from '@/views/admin-crud/entities/fieldHelpers'
import { readonlyCrudCapabilities, type EntityFieldDef } from '@/views/admin-crud/types'
...
const orderCapabilities = { create: false, edit: true, view: true, delete: false, toggleActive: false }

const allOrderFields: EntityFieldDef<OrderRow>[] = [
  { name: 'orderNo', label: 'OrderNo', type: 'text', table: { variant: 'code' }, form: false },
  { name: 'customerId', label: 'CustomerId', type: 'number', table: true, form: false },
  { name: 'customerName', label: 'Customer', type: 'text', table: { variant: 'primary' }, form: false },
  { name: 'totalAmount', label: 'TotalAmount', type: 'number', table: true, form: false },
  { name: 'paymentStatus', label: 'PaymentStatus', type: 'text', table: true, form: false },
  { name: 'orderStatus', label: 'OrderStatus', type: 'text', table: true, form: false },
...
const pendingOrderFields: EntityFieldDef<OrderRow>[] = [
  { name: 'orderNo', label: 'OrderNo', type: 'text', table: { variant: 'code' }, form: false },
  { name: 'customerName', label: 'Customer', type: 'text', table: { variant: 'primary' }, form: false },
  { name: 'totalAmount', label: 'Amount', type: 'number', table: true, form: false },
  { name: 'paymentMethod', label: 'PaymentMethod', type: 'text', table: true, form: false },
  { name: 'expiredAt', label: 'ExpiredAt', type: 'text', table: true, form: false },
  { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
]

const processingOrderFields: EntityFieldDef<OrderRow>[] = [
  { name: 'orderNo', label: 'OrderNo', type: 'text', table: { variant: 'code' }, form: false },
  { name: 'productName', label: 'Product', type: 'text', table: { variant: 'primary' }, form: false },
  { name: 'providerName', label: 'Provider', type: 'text', table: true, form: false },
  { name: 'processingStartedAt', label: 'ProcessingStartedAt', type: 'text', table: true, form: false },
  { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
]

const failedOrderFields: EntityFieldDef<OrderRow>[] = [
  { name: 'orderNo', label: 'OrderNo', type: 'text', table: { variant: 'code' }, form: false },
  { name: 'errorReason', label: 'ErrorReason', type: 'text', table: { variant: 'primary' }, form: false },
  { name: 'lastProviderResponse', label: 'LastProviderResponse', type: 'text', table: true, form: false },
  { name: 'assignedStaff', label: 'AssignedStaff', type: 'text', table: true, form: false },
  { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
]
...
export const paymentTransactionsEntity = defineAdminEntity<PaymentTransaction>({
  ...
  fields: [
    { name: 'transactionCode', label: 'TransactionCode', type: 'text', table: { variant: 'code' }, form: false },
    { name: 'orderId', label: 'OrderId', type: 'number', table: true, form: false },
    { name: 'provider', label: 'Provider', type: 'text', table: true, form: false },
    { name: 'amount', label: 'Amount', type: 'number', table: true, form: false },
    { name: 'status', label: 'Status', type: 'text', table: true, form: false },
    { name: 'paidAt', label: 'PaidAt', type: 'text', table: true, form: false },
    { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
  ],
})
...
export const paymentProvidersEntity = defineAdminEntity<PaymentProvider>({
  ...
  fields: [
    ...
    { name: 'merchantId', label: 'MerchantId', type: 'text', form: { required: true } },
    { name: 'secretKey', label: 'SecretKey', type: 'password', form: { required: true } },
...
export const paymentMethodsEntity = defineAdminEntity<PaymentMethod>({
  ...
  fields: [
    ...
    { name: 'iconUrl', label: 'IconUrl', type: 'url', table: true, form: { col: 6 } },
    { name: 'feePercent', label: 'FeePercent', type: 'number', table: true, form: { col: 6 } },
...
export const paymentCallbacksEntity = defineAdminEntity<PaymentCallback>({
  ...
  fields: [
    { name: 'receivedAt', label: 'ReceivedAt', type: 'text', table: true, form: false },
    { name: 'provider', label: 'Provider', type: 'text', table: true, form: false },
    { name: 'rawPayload', label: 'RawPayload', type: 'textarea', form: false, table: false },
    { name: 'processStatus', label: 'ProcessStatus', type: 'text', table: true, form: false },
    { name: 'signatureValid', label: 'SignatureValid', type: 'checkbox', table: true, form: false },
    { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
  ],
})
...
export const paymentRefundsEntity = defineAdminEntity<PaymentRefund>({
  ...
  fields: [
    { name: 'orderId', label: 'OrderId', type: 'number', table: true, form: { required: true, col: 6 } },
    { name: 'amount', label: 'Amount', type: 'number', table: true, form: { required: true, col: 6 } },
    { name: 'reason', label: 'Reason', type: 'textarea', form: { required: true } },
    { name: 'status', label: 'Status', type: 'text', table: true, form: { required: true, col: 6 } },
    { name: 'approvedBy', label: 'ApprovedBy', type: 'text', table: true, form: { col: 6 } },
    { name: 'refundedAt', label: 'RefundedAt', type: 'text', table: true, form: { col: 6 } },
    { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
  ],
})
...
export const deliveriesListEntity = defineAdminEntity<DigitalDelivery>({
  ...
  capabilities: { create: false, edit: true, view: true, delete: false, toggleActive: false },
  seedData: [
    {
      id: 1,
      orderId: 1,
  ...
  fields: [
    { name: 'orderId', label: 'OrderId', type: 'number', table: { variant: 'code' }, form: false },
    { name: 'deliveryType', label: 'DeliveryType', type: 'text', table: true, form: false },
    { name: 'status', label: 'Status', type: 'text', table: true, form: false },
    { name: 'sentAt', label: 'SentAt', type: 'text', table: true, form: false },
...
export const esimProfilesEntity = defineAdminEntity<EsimProfile>({
  ...
  fields: [
    ...
    { name: 'orderItemId', label: 'OrderItemId', type: 'number', table: true, form: false },
    { name: 'qrCodeUrl', label: 'QrCodeUrl', type: 'url', table: true, form: false },
    { name: 'activationCode', label: 'ActivationCode', type: 'text', table: true, form: false },
    { name: 'status', label: 'Status', type: 'text', table: true, form: false },
    { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
  ],
})
...
export const deliveredCodesEntity = defineAdminEntity<DeliveredCode>({
  ...
  fields: [
    ...
    { name: 'pinCode', label: 'PinCode', type: 'text', table: true, form: false },
    { name: 'orderItemId', label: 'OrderItemId', type: 'number', table: true, form: false },
    { name: 'expiredAt', label: 'ExpiredAt', type: 'text', table: true, form: false },
    { name: 'status', label: 'Status', type: 'text', table: true, form: false },
    { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
...
export const deliveryLogsEntity = defineAdminEntity<DeliveryLog>({
  ...
  fields: [
    { name: 'createdAt', label: 'CreatedAt', type: 'text', table: true, form: false },
    { name: 'deliveryId', label: 'DeliveryId', type: 'number', table: true, form: false },
