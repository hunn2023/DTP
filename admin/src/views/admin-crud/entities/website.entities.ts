...
export const postsEntity = defineAdminEntity<Post>({
  ...
  fields: [
    { name: 'title', label: 'Title', type: 'text', table: { variant: 'primary' }, form: { required: true } },
    { name: 'slug', label: 'Slug', type: 'text', table: { variant: 'code' }, form: { required: true } },
    { name: 'thumbnailUrl', label: 'ThumbnailUrl', type: 'url', table: true, form: { col: 6 } },
    { name: 'summary', label: 'Summary', type: 'textarea', form: { col: 6 } },
    { name: 'content', label: 'Content', type: 'textarea', form: { required: true } },
    { name: 'status', label: 'Status', type: 'text', table: true, form: { required: true, col: 6 } },
    { name: 'publishedAt', label: 'PublishedAt', type: 'text', table: true, form: { col: 6 } },
    { name: 'seoTitle', label: 'SeoTitle', type: 'text', form: { col: 6 } },
    { name: 'seoDescription', label: 'SeoDescription', type: 'textarea', form: { col: 6 } },
    isActiveField<Post>(),
  ],
})
...
export const pagesEntity = defineAdminEntity<StaticPage>({
  ...
  fields: [
    ...
    { name: 'status', label: 'Status', type: 'text', table: true, form: { required: true, col: 6 } },
    { name: 'seoTitle', label: 'SeoTitle', type: 'text', form: { col: 6 } },
    { name: 'seoDescription', label: 'SeoDescription', type: 'textarea' },
...
export const bannersEntity = defineAdminEntity<Banner>({
  ...
  fields: [
    { name: 'title', label: 'Title', type: 'text', table: { variant: 'primary' }, form: { required: true } },
    { name: 'imageDesktopUrl', label: 'ImageDesktopUrl', type: 'url', table: true, form: { required: true } },
    { name: 'imageMobileUrl', label: 'ImageMobileUrl', type: 'url', table: true, form: { col: 6 } },
    { name: 'linkUrl', label: 'LinkUrl', type: 'url', form: { required: true, col: 6 } },
    { name: 'position', label: 'Position', type: 'text', table: true, form: { required: true, col: 6 } },
    { name: 'startDate', label: 'StartDate', type: 'text', form: { col: 6 } },
    { name: 'endDate', label: 'EndDate', type: 'text', form: { col: 6 } },
...
export const mediaEntity = defineAdminEntity<MediaFile>({
  ...
  fields: [
    { name: 'fileName', label: 'FileName', type: 'text', table: { variant: 'primary' }, form: { required: true } },
    { name: 'url', label: 'Url', type: 'url', table: true, form: { required: true } },
    { name: 'mimeType', label: 'MimeType', type: 'text', table: true, form: { col: 6 } },
    { name: 'size', label: 'Size', type: 'number', table: true, form: { col: 6 } },
    { name: 'folder', label: 'Folder', type: 'text', table: true, form: { col: 6 } },
...
export const seoHomepageEntity = defineAdminEntity<SeoSetting>({
  ...
  fields: [
    { name: 'pageKey', label: 'PageKey', type: 'text', table: { variant: 'code' }, form: { required: true } },
    { name: 'seoTitle', label: 'SeoTitle', type: 'text', form: { required: true } },
    { name: 'seoDescription', label: 'SeoDescription', type: 'textarea', form: { required: true } },
    { name: 'seoKeywords', label: 'SeoKeywords', type: 'text', form: { col: 6 } },
    { name: 'canonicalUrl', label: 'CanonicalUrl', type: 'url', form: { col: 6 } },
    { name: 'schemaJson', label: 'SchemaJson', type: 'textarea' },
    { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
  ],
})
...
export const seoCountriesEntity = defineAdminEntity<CountrySeo>({
  ...
  fields: [
    ...
    { name: 'seoTitle', label: 'SeoTitle', type: 'text', table: { variant: 'primary' }, form: { required: true } },
    { name: 'seoDescription', label: 'SeoDescription', type: 'textarea', form: { required: true } },
    { name: 'contentHtml', label: 'ContentHtml', type: 'textarea', form: { required: true } },
    { name: 'canonicalUrl', label: 'CanonicalUrl', type: 'url', table: true, form: { col: 6 } },
    { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
  ],
})
