...
const ProductVariantsTab = ({ productId }: Props) => {
  const crud = useProductVariantsCrud({ productId, buildColumns: buildVariantColumns })
  ...
  return (
    <Card className="border-0 shadow-none">
      ...
      {crud.isLoading ? (
        ...
        <DataTable table={crud.table} emptyMessage="Chưa có biến thể" />
      )}
