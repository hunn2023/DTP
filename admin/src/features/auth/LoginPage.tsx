...
const LoginPage = () => {
  ...
  <>
    ...
    <div
      className="auth-box overflow-hidden align-items-center d-flex position-relative"
      style={{
        minHeight: '100vh',
        backgroundImage: `linear-gradient(rgba(255,255,255,0.72), rgba(255,255,255,0.72)), url('/images/bg.jpg')`,
      ...
      <Container>
        <Row className="justify-content-center">
          <Col xxl={4} md={6} sm={8}>
               <Card className="p-4 rounded-4 shadow-lg border-0">
            <div className="auth-brand text-center mb-4">
              ...
              © {currentYear} EZSIM — by <span className="fw-semibold">{author}</span>
            </p>
            </Card>
