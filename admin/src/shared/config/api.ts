...
export const API_PATHS = {
  ...
  adminReportsProducts: '/api/admin/reports/products',
  adminReportsPayments: '/api/admin/reports/payments',
  ...
  adminContentPages: '/api/admin/content/pages',
  adminContentSeo: '/api/admin/content/seo',
} as const
