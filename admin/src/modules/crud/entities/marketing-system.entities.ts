...
export const emailTemplatesEntity = defineAdminEntity<EmailTemplate>({
  ...
  fields: [
    { name: 'code', label: 'Mã', type: 'text', table: { variant: 'code' }, form: { required: true } },
    { name: 'subject', label: 'Tiêu đề', type: 'text', form: { required: true } },
    { name: 'bodyHtml', label: 'Nội dung (HTML)', type: 'textarea', form: { required: true } },
    { name: 'variables', label: 'Biến', type: 'text', form: { placeholder: 'name,qrUrl' } },
    { name: 'isActive', label: 'Kích hoạt', type: 'checkbox', form: { col: 12 } },
  ],
})
...
export const emailQueueEntity = defineAdminEntity<EmailQueueItem>({
  ...
  fields: [
    { name: 'toEmail', label: 'Email nhận', type: 'text', table: { variant: 'primary' }, form: false },
    { name: 'templateCode', label: 'Mã template', type: 'text', table: true, form: false },
    { name: 'status', label: 'Trạng thái', type: 'text', table: true, form: false },
    { name: 'retryCount', label: 'Số lần thử lại', type: 'number', table: true, form: false },
    { name: 'scheduledAt', label: 'Lên lịch lúc', type: 'text', table: true, form: false },
...
export const permissionsEntity = defineAdminEntity<Permission>({
  ...
  fields: [
    ...
    { name: 'action', label: 'Hành động', type: 'text', table: true, form: { col: 6 } },
    { name: 'isActive', label: 'Bật', type: 'checkbox', form: { col: 12 } },
  ],
})
...
export const auditLogsEntity = defineAdminEntity<AuditLog>({
  ...
  fields: [
    { name: 'createdAt', label: 'Thời gian', type: 'text', table: true, form: false },
    { name: 'userId', label: 'ID người dùng', type: 'number', table: true, form: false },
    { name: 'userEmail', label: 'Người dùng', type: 'text', table: true, form: false },
    { name: 'entityName', label: 'Đối tượng', type: 'text', table: true, form: false },
    { name: 'entityId', label: 'ID đối tượng', type: 'number', table: true, form: false },
    { name: 'action', label: 'Hành động', type: 'text', table: true, form: false },
    { name: 'oldValue', label: 'Giá trị cũ', type: 'text', table: true, form: false },
    { name: 'newValue', label: 'Giá trị mới', type: 'text', table: true, form: false },
    { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
  ],
})
...
export const systemSettingsEntity = defineAdminEntity<SystemSetting>({
  ...
  fields: [
    ...
    { name: 'value', label: 'Giá trị', type: 'text', table: true, form: { required: true } },
    { name: 'group', label: 'Nhóm', type: 'text', table: true, form: { col: 6 } },
    { name: 'description', label: 'Mô tả', type: 'textarea' },
    { name: 'isEncrypted', label: 'Mã hóa', type: 'checkbox', table: true, form: { col: 6 } },
    { name: 'isActive', label: '—', type: 'checkbox', form: false, table: false },
  ],
})
