        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtpCodeHash = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    OtpExpiredAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    VerifyFailedCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthAttemptLogs_CreatedAt",
                table: "AuthAttemptLogs",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AuthAttemptLogs_IpAddress",
                table: "AuthAttemptLogs",
                column: "IpAddress");
