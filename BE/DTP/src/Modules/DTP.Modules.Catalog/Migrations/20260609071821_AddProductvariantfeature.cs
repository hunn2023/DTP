...
{
    /// <inheritdoc />
    public partial class AddProductvariantfeature : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlagKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderPackageCode = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    DataAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DataUnit = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    CoverageDescription = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ActivationPolicy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SpeedPolicy = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    HotspotSupported = table.Column<bool>(type: "bit", nullable: false),
                    PhoneNumberSupported = table.Column<bool>(type: "bit", nullable: false),
                    SmsSupported = table.Column<bool>(type: "bit", nullable: false),
                    KycRequired = table.Column<bool>(type: "bit", nullable: false),
                    QrDeliveryType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EsimPackages_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhoneCards", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantFeatures", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EsimPackageCarrier", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EsimPackageCarrier_Carriers_CarrierId",
                        column: x => x.CarrierId,
                        principalTable: "Carriers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EsimPackageCarrier_EsimPackages_EsimPackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carriers_CountryId_Name",
                table: "Carriers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EsimPackageCarrier_CarrierId",
                table: "EsimPackageCarrier",
                column: "CarrierId");

            migrationBuilder.CreateIndex(
                name: "IX_EsimPackageCarrier_EsimPackageId",
                table: "EsimPackageCarrier",
                column: "EsimPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_EsimPackages_CountryId_IsActive_SortOrder",
                table: "EsimPackages",
                columns: new[] { "CountryId", "IsActive", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_EsimPackages_ProductId_ProductVariantId_ProviderId_CountryId",
                table: "EsimPackages",
                columns: new[] { "ProductId", "ProductVariantId", "ProviderId", "CountryId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EsimPackages_ProviderPackageCode",
                table: "EsimPackages",
                column: "ProviderPackageCode");

            migrationBuilder.CreateIndex(
                name: "IX_EsimPackages_Slug",
                table: "EsimPackages",
                column: "Slug",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAttributes_ProductId_SortOrder",
                table: "ProductAttributes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantFeatures_ProductVariantId",
